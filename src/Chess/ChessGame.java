...
public class ChessGame {
	...
	public void restartGame(long playerClockTime){
		gameBoard.resetBoard();
		if (activePlayer.getColor().equals(Color.BLACK)) {
			ChessPlayer t = activePlayer;
			activePlayer = inactivePlayer;
			inactivePlayer = t;
		}
		//activePlayer.getChessClock().resetTimer(playerClockTime);
		//inactivePlayer.getChessClock().resetTimer(playerClockTime);
	}
	...
	public boolean endGame(Color winningColor) {
		//Hansen@Vinny: What's the point of this method?
		return false;
	}
